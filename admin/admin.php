...
<body class="bg-gray-100 text-gray-800">
    ...
    <div class="flex min-h-screen">
        <!-- Sidebar -->
        <aside id="sidebar" class="w-64 bg-[#232526] text-white flex-shrink-0 fixed inset-y-0 left-0 z-50 transform -translate-x-full transition-transform duration-300 lg:relative lg:translate-x-0 h-screen lg:h-auto overflow-y-auto lg:overflow-visible">
            <!-- Logo -->
