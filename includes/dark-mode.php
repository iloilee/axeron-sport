...
<style>
    ...
    html.dark .bg-surface-container-lowest, html.dark .bg-surface-lowest, html.dark .bg-gray-50, html.dark .bg-surface-container, html.dark .bg-surface-container-high, html.dark .bg-surface-container-low, html.dark .bg-surface-container-lowest\/80, html.dark .bg-surface-container-lowest\/50, html.dark .bg-\[\#fcf9f8\], html.dark .bg-\[\#F5F5F5\], html.dark .bg-\[\#ffffff\] { background-color: #2D2E30 !important; }
    ...
    html.dark .bg-surface-gray { background-color: #202124 !important; border-color: #5f6368 !important; }
    html.dark .bento-card { background: linear-gradient(145deg, #2D2E30 0%, #202124 100%) !important; border-color: #5f6368 !important; }
    html.dark .hover\:bg-surface-container:hover, html.dark .hover\:bg-surface-container-low:hover, html.dark .hover\:bg-surface-container-lowest:hover, html.dark .hover\:bg-gray-50:hover, html.dark .hover\:bg-gray-100:hover, html.dark .hover\:bg-surface-gray:hover, html.dark .bg-surface-variant { background-color: #4a4d51 !important; }
